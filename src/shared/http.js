...
export function createPost(payload) {
    ...
    return fetch(`${process.env.REACT_APP_ENDPOINT}/posts`, generateFetchConfig('POST', payload));
}
...
export function fetchPost(id) {
    return fetch(
        ...
        `${process.env.REACT_APP_ENDPOINT}/posts/${id}`,
...
export function loadUser(id) {
    return fetch(`${process.env.REACT_APP_URL}/api/user/${id}`, generateFetchConfig('GET'));
}
